...
isBranchBlocked() {
    ...
    echo "👺 ------> Final Workflow Branch: ${FINAL_WORKFLOW_BRANCH}"
    echo "👺 ------> After Target Branch: ${AFTER_TARGET_BRANCH}"
...
echo "👺 ------> Position Source: ${POSITION_SOURCE}"
echo "👺 ------> Position Target: ${POSITION_TARGET}"
